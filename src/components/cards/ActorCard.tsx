...
export function ActorCard(props: CardProps): JSX.Element {
  ...
  return (
    <div className="min-w-1/3 h-96 relative flex flex-col justify-center" >
      <div 
        className="absolute z-10 h-full w-2/5 top-0 left-8 bg-cover shadow-headshot" 
        style={{ backgroundImage: `url(${actor.primaryPhoto?.image.url})` }}>
      </div>
      <div className="h-80 bg-gray-100 flex justify-end text-gray-800">
        <div className="w-1/2 flex flex-col items-center  my-8 mr-2 bg-white shadow-bio" >
